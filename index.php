	...
	<div class="page new-skin">
		...
		<div class="container opened" data-animation-in="rollIn" data-animation-out="rollOut">
			...
			<header class="header">
				<!-- header profile -->
				<div class="profile">
					<div class="title">Renuka Mane</div>
			...
			<div class="card-started" id="home-card">
				...
				<div class="profile no-photo">
					...
					<!-- profile socials -->
					<div class="social">
						<a target="_blank" href="https://www.linkedin.com/in/renuka-mane-206500169?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><span class="fa fa-linkedin"></span></a>
						<a target="_blank" href="https://github.com/manerenuka"><span class="fa fa-github"></span></a>
						<a target="_blank" href="https://wa.me/918308028247"><span class="fa fa-whatsapp"></span></a>
					</div>
					</br>
					<div class="subtitle subtitle-typed ">
						<div class="typing-title">
